    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.btns}>
          <TouchableHighlight style={styles.actionBtn} underlayColor={theme['c-primary-alpha-100'] ?? 'rgba(77,175,124,0.9)'} onPress={handleRemoveFile}>
            <Text size={13} color={theme['c-button-font']}>{global.i18n.t('metadata_edit_modal_form_remove_pic')}</Text>
          </TouchableHighlight>
          <TouchableHighlight style={styles.actionBtn} underlayColor={theme['c-primary-alpha-100'] ?? 'rgba(77,175,124,0.9)'} onPress={onOnlineMatch}>
            <Text size={13} color={theme['c-button-font']}>{global.i18n.t('metadata_edit_modal_form_match_pic')}</Text>
          </TouchableHighlight>
          <TouchableHighlight style={styles.actionBtn} underlayColor={theme['c-primary-alpha-100'] ?? 'rgba(77,175,124,0.9)'} onPress={handleShowSelectFile}>
