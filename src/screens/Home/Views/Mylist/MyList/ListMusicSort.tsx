...
const CheckBoxItem = <T extends FieldName | FieldType>({ id, isActive, disabled, change, hasTVPreferredFocus }: {
  id: T
  isActive: boolean
  disabled?: boolean
  change: (id: T) => void
    ...
    <View>
      <View style={styles.formSection}>
        ...
        <View style={styles.formList}>
          {fieldNames.map((n, idx) => <CheckBoxItem key={n} id={n} isActive={name == n} change={setName} disabled={type == 'random'} hasTVPreferredFocus={idx === 0} />)}
        </View>
      </View>
      <View style={styles.formSection}>
